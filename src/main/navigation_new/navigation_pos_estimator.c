...
PG_RESET_TEMPLATE(positionEstimationConfig_t, positionEstimationConfig,
        ...
        .reset_altitude_type = NAV_RESET_ALTITUDE_ON_EACH_ARM,
        .gps_delay_ms = 200,
...
static void updateEstimatedTopic(timeUs_t currentTimeUs)
{
    ...
    bool isSurfaceValid = sensors(SENSOR_MWRADAR) && ((currentTimeUs - posEstimator.surface.lastUpdateTime) <= MS2US(INAV_SURFACE_TIMEOUT_MS));
